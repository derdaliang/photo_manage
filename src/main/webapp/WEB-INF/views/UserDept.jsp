...
<body>
    <div>
        <form class="form-horizontal media-middle" id="Add_input">
            ...
            <button type="submit" name="Submit" id="upload_btn" class="button">Add</button>
        </form>
    </div>
    ...
    <script type="text/javascript">
        $("#check_password").blur(function () {
           ...
           if(password==checkPassword){
               ...
               $("#upload_btn").attr("ajax-va","success");
           }else{
               $("#check_password_div").addClass("has-error");
               $("#upload_btn").attr("ajax-va","error");
           }
        });
        function
